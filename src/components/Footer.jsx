...
const Footer = () => {
  return (
    <>
      <footer className="footer-center md:footer p-10 md:px-16 bg-base-200 text-base-content">
        <aside>
          <div className="flex flex-col justify-center items-center md:items-start">
            <div className="w-32 h-32 drop-shadow-xl border rounded-full bg-inherit">
              <img
                src={Logo}
                alt="logo"
            ...
            <p className="mt-4 md:text-left">
              ...
              Brides and Makeup
              <br />
              Blok N 15-17, Darmo Hill, Jl. Pakis Bukit
              Akasia
              <br />
      ...
      <footer className="footer footer-center p-4 bg-base-300 text-base-content">
        <aside>
          <p>
            Copyright © 2024 - All right reserved by House
            of Lea
          </p>
        </aside>
      </footer>
